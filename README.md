...
This repository contains the code and resources for the "Build & Sell with Claude Code" course, designed to help entrepreneurs and developers leverage the power of AI to create and sell innovative products.
...
Chapter 4: Tokens/Context
Chapter 5: CLAUDE.md
Chapter 6: First Workflows
Chapter 7: Deploying Automations
Chapter 8: Project Architecture
Chapter 9: Built-in Commands
Chapter 10: RAG
Chapter 11: Building/Deploying Websites
Chapter 12: APIs / MCPs
Chapter 13: Google CLI
Chapter 14: Building your own Exec Assistant
Chapter 15: Skills
...
Chapter 21: GitHub
Chapter 22: Worktrees
Chapter 23: Fun Hacks
Chapter 24: Monetizing your Knowledge

## Agentic Workflows

**Agentic workflows** are a powerful way to automate complex tasks by leveraging the capabilities of AI agents. In this course, we will explore how to design and implement agentic workflows that can perform a wide range of functions, from data analysis to customer support.
